    ...
    <div class="overflow-hidden relative bg-white rounded-md border border-gray-200 hover:border-gray-300 transition cursor-pointer">
      ...
      >
        <button
          ...
          class={`flex h-4 w-4 items-center justify-center rounded border text-[10px] ${isCompleted
        ...
        <div class="flex min-w-0 flex-1 flex-col">
          <h3
            class={`truncate text-sm ${isCompleted ? "text-gray-400 line-through" : "text-gray-800"
              }`}
          >
            {title}
          </h3>
